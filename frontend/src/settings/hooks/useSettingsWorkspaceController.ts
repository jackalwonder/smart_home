  ...
  return {
    ...
    sectionPanelProps: {
      ...
      backup: {
        ...
        handleRestoreBackup: (backup: BackupListItemDto) => void handleRestoreBackup(backup),
      ...
      integrations: {
        ...
        handleTestSystemConnection: (saved: boolean) => void handleTestSystemConnection(saved),
    ...
    settings,
    shouldShowActionDock: shouldShowSettingsActionDock(activeSection),
    showPinManager,
