    ...
    <div className="settings-form-grid">
      ...
      <label className="form-field">
        ...
        >
          ...
          {hotspot.deviceId &&
          !devices.some((device) => device.device_id === hotspot.deviceId) ? (
      ...
      <label className="form-field">
        ...
        >
          ...
          {hotspot.iconType &&
          !HOTSPOT_ICON_OPTIONS.some((option) => option.value === hotspot.iconType) ? (
        ...
        <div className="editor-hotspot-icon-picker__grid">
          {HOTSPOT_ICON_OPTIONS.map((option) => (
            <button
              ...
              className={
                hotspot.iconType === option.value && !hotspot.iconAssetId ? "is-selected" : ""
              }
              disabled={!canEdit}
              key={option.value}
