...
export const TERMINAL_ID = "22222222-2222-2222-2222-222222222222";
export const SECONDARY_TERMINAL_ID = "33333333-3333-3333-3333-333333333333";
export const DEV_PIN = "1234";
export const SMOKE_ROOM_ID = "11111111-1111-1111-1111-000000000010";
export const SMOKE_DEVICE_ID = "11111111-1111-1111-1111-000000000101";
export const BOOTSTRAP_TOKEN_STORAGE_KEY = "smart_home.bootstrap_token";
export const TERMINAL_ACTIVATION_TEST =
  "terminal activation stores bootstrap token and enters shell";
export const TERMINAL_ACTIVATION_LINK_TEST =
  "terminal activation link auto-activates and persists bootstrap token";
export const TERMINAL_ACTIVATION_CODE_TEST =
  "terminal activation code can be pasted and persists bootstrap token";
export const TERMINAL_PAIRING_TEST =
  "terminal pairing code can be claimed and auto-activates the terminal";
export const TERMINAL_ACTIVATION_ENTRY_TEST =
  "terminal activation exposes scan code and pairing task entries";
export const TERMINAL_ACTIVATION_LANDING_TEST =
  "terminal activation success landing shows destination before home";
export const DEVICE_SYNC_TIMEOUT_MS = 45_000;
export const DEVICE_SYNC_POLL_INTERVAL_MS = 1_000;
export const bootstrapTokens = new Map<string, string>();
export const primedHomes = new Set<string>();
...
export type SupportedControlRequest = {
  action_type: string;
  device_id: string;
  payload: {
...
export function installSmokeBootstrapHook() {
...
export function toEditorSaveHotspots(
...
export async function bootstrapSession(request: APIRequestContext, terminalId = TERMINAL_ID) {
...
export function issueBootstrapToken(terminalId = TERMINAL_ID) {
...
export function buildActivationCode(token: string) {
  return `smart-home-activate:${token}`;
}

export function seedSmokeDeviceFixture() {
...
export async function ensureControllableHotspot(
...
export async function tryFindSupportedControlRequest(
  request: APIRequestContext,
  accessToken: string,
...
export async function ensureDevicesReady(
  request: APIRequestContext,
  accessToken: string,
...
export async function saveCurrentSettingsSnapshot(
  request: APIRequestContext,
  accessToken: string,
...
export async function forceRealtimeDisconnect(page: Page) {
  await page.evaluate(() => {
    window.__smartHomeRealtime?.forceDisconnect();
  });
}

export function ensureSecondaryTerminal() {
  execFileSync(
    "docker",
    [
      "compose",
...
export function clearPairingSessions(terminalId: string) {
  execFileSync(
    "docker",
    [
      "compose",
...
export async function openRealtimeProbe(page: Page, accessToken: string) {
  await page.goto("/");
...
export async function unlockManagementPin(page: Page) {
  await page.goto("/");
...
export async function openSettingsTaskFlow(page: Page) {
...
export async function openDeliveryDetails(page: Page) {
  await page
...
export async function openBackupDetails(page: Page) {
  await page
    .getByRole("navigation", { name: "设置分区" })
...
export async function openEditorWorkspace(page: Page) {
...
export async function openHomeDashboard(page: Page) {
  await page
...
export async function readEditorFieldValue(page: Page, label: string) {
...
export async function ensureEditorWritable(page: Page) {
